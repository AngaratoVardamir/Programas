...
# Frames
framedatela = Frame(janela, width=1, height=1, bg=Cor_Azul)
...
Botão_7 = Button(frame_Corpo, command = lambda: Entrar_Valores('*') ,text="X", width=5, height=2, bg=Cor_Laranja, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
